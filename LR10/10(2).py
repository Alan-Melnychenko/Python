import datetime
class Date():
    def init(self, _day, _month, _year):
        self.day = _day
        self.month = _month
        self.year = _year
class Traveller():
    def init(self, _day, _month, _year, _surname_and_initials, _profession,_day_of_birth, _month_of_birth, _year_of_birth, _country, _region, _city_or_village, _street, _house, _term, _date):
...
class Adress_of_traveller():
    def init(self, _country, _region, _city_or_village, _street, _house, _term, _date):
